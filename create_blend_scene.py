...
# Switch back to object mode before adding the camera and lights
bpy.ops.object.mode_set(mode='OBJECT')
...
# Save the .blend file
blend_file_path = '/media/backup_005_6/workspace_all/blender/character_animation_scene.blend'
bpy.ops.wm.save_as_mainfile(filepath=blend_file_path)

print(f".blend scene created and saved to {blend_file_path}")
